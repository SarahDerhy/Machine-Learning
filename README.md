...
```text
Final - MachineLearningProject2.6.ipynb
```
...
The first cells import the required libraries and download the necessary data. IMDb crew data is also loaded automatically from IMDb.
